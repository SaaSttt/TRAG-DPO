...
def calc_top1_labels(qB, rB, query_L, retrieval_L, k=None):
    ...
    for iter in range(num_query):
        ...
        # 获取top1的标签
        top1_index = ind[0]
        top1_label = retrieval_L[top1_index]
        
        top1_labels.append(top1_label)  # 将top1标签添加到列表中
    
    return top1_labels  # 只返回top1标签列表
